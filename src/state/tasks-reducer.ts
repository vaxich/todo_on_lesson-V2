...
import { addTodolistACType, DeleteTodolistACType } from "./todolists-reducer";

export const tasksReducer = (state: TasksState, action: tasksReducerAtionType) => {
    switch (action.type) {
        case 'REMOVE-TASK': {
...
type tasksReducerAtionType = removeTaskACType | addTaskACType | changeTaskStatusACType | changeTaskTitleACType | addTodolistACType | DeleteTodolistACType

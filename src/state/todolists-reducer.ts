...
export const todolistReducer = (state= initialState, action: todolistReducerType): Todolist[] => {
    switch (action.type) {
        ...
        case 'ADD-TODOLIST': {
            ...
            let newTodolist: Todolist = { id: action.payload.todolistId, title: action.payload.newTile, filter: 'All' }
